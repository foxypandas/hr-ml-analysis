...
Данные компании о сотрудниках: должностной уровень, стаж, зарплата, загруженность, оценка руководителя, нарушения контракта, продвижения — и целевые переменные (удовлетворённость, факт увольнения). Предобработка и кодирование собраны в **sklearn-пайплайны** (OrdinalEncoder, OneHotEncoder, масштабирование); корреляционный анализ выполнен через **phik** (наибольшая связь с удовлетворённостью — у оценки руководителя, phik = 0.78).
